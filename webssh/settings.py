...
define('get_host_info_url', default='http://127.0.0.1:8000/cmdb/get/host/info/api/', help='get host info')
define('allow_origin', default='http://127.0.0.1:8000', help='Access-Control-Allow-Origin')
define('allow_headers', default='x-requested-with Origin,Content-Type,X-XSRFToken,X-CSRFToken',
